...
static void mdio_write_phy_ocp(struct rtl8101_private *tp,
                               u16 PageNum,
                               u32 RegAddr,
                               u32 value)
{
...
static void ClearEthPhyBit(struct rtl8101_private *tp, u8 addr, u16 mask)
{
...
static void SetEthPhyBit(struct rtl8101_private *tp,  u8  addr, u16  mask)
{
        ClearAndSetEthPhyBit( tp,
                              addr,
                              0,
